...
(function() {
    ...
    Ta.prototype.add = function(a, b, c, d, f) {
        ...
        var k = Ua(a, b, d, f);
        -1 < k ? (b = a[k],
        c || (b.sa = !1)) : (b = new Ra(b,this.src,g,!!d,f),
        b.sa = c,
        a.push(b));
        return b
    }
    ...
    function Xa(a, b) {
        ...
        return ra(a.a, function(g) {
            for (var k = 0; k < g.length; ++k)
                if (!(c && g[k].type != d || f && void 0 != g[k].capture))
                    return !0;
            return !1
        })
    }
    function Ua(a, b, c, d) {
        for (var f = 0; f < a.length; ++f) {
            var g = a[f];
            if (!g.ca && g.listener == b && g.capture == !!c && g.va == d)
                return f
        }
        return -1
    }
    ...
    function Cb(a, b, c, d, f) {
        if (ea(b))
            ...
            0 == g.length && (delete a.a[b],
            a.b--)))) : a && (a = yb(a)) && (c = Wa(a, b, c, d, f)) && Db(c)
    }
    function Db(a) {
    ...
    z.prototype.N = function() {
        ...
        if (this.O) {
            var a = this.O, b = 0, c;
            for (c in a.a) {
                for (var d = a.a[c], f = 0; f < d.length; f++)
                    ++b,
                    Sa(d[f]);
                delete a.a[c];
                a.b--
    ...
    e.ub = function() {
        if (this.W) {
            var a = la() - this.m;
            0 < a && a < .8 * this.a ? this.U = this.b.setTimeout(this.i, this.a - a) : (this.U && (this.b.clearTimeout(this.U),
            this.U = null),
            A(this, "tick"),
            this.W && (this.U = this.b.setTimeout(this.i, this.a),
            this.m = la()))
        }
    }
    ;
    e.start = function() {
        this.W = !0;
        this.U || (this.U = this.b.setTimeout(this.i, this.a),
        this.m = la())
    }
    ;
    e.stop = function() {
        this.W = !1;
        this.U && (this.b.clearTimeout(this.U),
        this.U = null)
    }
    ;
    e.N = function() {
    ...
    function Zb(a) {
        var b;
        if (Pb && !(w && jb("9") && !jb("10") && h.SVGElement && a instanceof h.SVGElement) && (b = a.parentElement))
            return b;
        b = a.parentNode;
    ...
    function ac(a, b) {
        ...
        if (!c) {
            var d = xa(b);
            c = d;
            void 0 === a.style[d] && (d = (db ? "Webkit" : cb ? "Moz" : w ? "ms" : ab ? "O" : null) + ya(d),
    ...
    function hc(a) {
        var b = Sb(a)
          , c = w && a.currentStyle;
        if (c && "CSS1Compat" == Qb(b).a.compatMode && "auto" != c.width && "auto" != c.height && !c.boxSizing)
            return b = ic(a, c.width, "width", "pixelWidth"),
        ...
        !w || 9 <= Number(kb) ? (d = cc(a, "borderLeftWidth"),
        f = cc(a, "borderRightWidth"),
        g = cc(a, "borderTopWidth"),
        a = cc(a, "borderBottomWidth"),
        a = new Mb(parseFloat(g),parseFloat(f),parseFloat(a),parseFloat(d))) : (d = kc(a, "borderLeft"),
        f = kc(a, "borderRight"),
        g = kc(a, "borderTop"),
        a = kc(a, "borderBottom"),
        a = new Mb(g,f,a,d));
    ...
    e.T = function(a, b) {
        ...
        tc(a, this);
        Ia(this.B, c, 0, a);
        a.H && this.H && a.F == this ? (b = this.ia(),
        c = b.childNodes[c] || null,
        c != a.c() && b.insertBefore(a.c(), c)) : b ? (this.m || this.w(),
        c = L(this, c + 1),
        I(a, this.ia(), c ? c.m : null)) : this.H && !a.H && a.m && a.m.parentNode && 1 == a.m.parentNode.nodeType && a.A()
    }
    ;
    e.ia = function() {
        return this.m
    ...
    ;
    function uc(a) {
        for (var b = []; a.B && 0 != a.B.length; )
            b.push(a.removeChild(L(a, 0), !0));
        return b
    }
    ;function M(a) {
        rc.call(this, a);
    ...
    function Hc(a, b) {
        if (a.l != b) {
            ...
            c && (a.a ? a.o = b : (a.C = Bc * (null === a.l ? .3 : 1),
            a.l = b,
            a.o = null,
            a.a || (a.a = D(a.i, "IMG"),
            a.b.appendChild(a.a),
            E(a.a, Jc),
            b = a.C,
            E(a.a, "transition", 0 < b ? "opacity " + .001 * b + "s ease" : "none"),
            x(a.a, "load", a.Db, !1, a)),
            E(a.a, "z-index", 2),
            F(a.a, 0),
            a.a.src = c.src))
    ...
    Pc.prototype.Fa = function() {
        ...
        if (this.i != this.a.length) {
            ...
            for (b = a = 0; a < this.a.length; )
                c = this.a[a],
                Object.prototype.hasOwnProperty.call(d, c) || (this.a[b++] = c,
                d[c] = 1),
                a++;
            this.a.length = b
        }
    ...
    Pc.prototype.set = function(a, b) {
        Object.prototype.hasOwnProperty.call(this.b, a) || (this.i++,
        this.a.push(a));
        this.b[a] = b
    }
    ;
    ...
    function pd(a, b) {
        ...
        try {
            Q(a.b, qd(a, "Opening Xhr")),
            a.o = !0,
            a.a.open("GET", String(b), !0),
            a.o = !1
        } catch (f) {
        ...
        try {
            ...
            a.j ? (a.a.timeout = a.F,
            a.a.ontimeout = m(a.ib, a)) : a.h = Kb(a.ib, a.F, a)),
            Q(a.b, qd(a, "Sending request")),
            a.f = !0,
            a.a.send(""),
            a.f = !1
        } catch (f) {
            Q(a.b, qd(a, "Send error: " + f.message)),
            rd(a, f)
        }
    }
    function td(a) {
    ...
    e.ib = function() {
        "undefined" != typeof aa && this.a && (this.B = "Timed out after " + this.F + "ms, aborting",
    ...
    e.abort = function() {
        this.a && this.i && (Q(this.b, qd(this, "Aborting")),
        this.i = !1,
        this.m = !0,
        this.a.abort(),
        this.m = !1,
                ...
                try {
                    ...
                    if (d)
                        ...
                        try {
                            ...
                            Q(a.b, "Can not get status: " + Ic.message),
                            u = ""
                        }
                        a.B = u + " [" + yd(a) + "]";
                        ud(a)
    ...
    function P(a, b) {
        if (a.classList)
            ...
            if (a.classList)
                ...
                a.classList ? c = a.classList : (c = a.className,
                c = l(c) && c.match(/\S+/g) || []),
                c = !(0 <= Ca(c, b));
    ...
    ;
    e.nc = function(a) {
        this.j && (this.a = this.b + (this.h - this.b) * (a.clientX - this.f) / this.l.width,
        A(this, Id),
        Dd(this))
    }
    ;
    ...
    e.pa = function() {
        this.f === Kd && (this.f = 1,
        this.l.setAttribute("src", this.C),
        this.a.load())
    }
    ;
    function Nd(a) {
    ...
    ;
    function S(a, b) {
        "boolean" == typeof a ? b = !0 === a : l(a) ? (a = a.toLowerCase(),
        b = "true" === a ? !0 : "false" === a ? !1 : !0 === b) : b = !0 === b;
        return b
    }
    function Xd(a) {
        return l(a) ? a : null
    ...
    je.prototype.m = function() {
        var a = Vb(this.a || window)
          , b = this.b;
        a == b || a && b && a.width == b.width && a.height == b.height || (this.b = a,
        A(this, "resize"))
    }
    ;
    function ke(a) {
    ...
    function we(a, b) {
        ...
        b instanceof Element && (t((b || document).getElementsByTagName("OBJECT"), function(f) {
            ...
            k && (f = f.getAttribute("type") || "image/jpeg",
            g.src = k,
            g.mimetype = f,
            Ga(d, g))
        }, a),
        t((b || document).getElementsByTagName("IMG"), function(f) {
            f = $d(f);
            Ga(d, f)
        }, a));
        ve(a, d);
    ...
    function ze(a, b) {
        ...
        default:
            d = new ke;
            null !== b.width && 0 < b.width && null !== b.height && 0 < b.height && (d.u = new C(b.width,b.height),
            O(d) && (d.j = hc(d.c()),
            Lc(d)));
            d.J = b.aspectRatio;
            O(d) && Lc(d);
        ...
        l(b.description) && (c = new ae,
        c.b = b.description,
        O(c) && $b(c.a, null !== c.b ? c.b : ""),
        a.T(c, !0))
    }
    e.pb = function() {
    ...
    var Ye = {
      ...
      , $e = {
        en: "Publicalbum.org photo sharing website"
    };
    function af(a) {
        R.call(this, a)
    }
    ...
    e.update = function() {
        ...
        Yf(this);
        Wf(this);
        this.u || (this.c().removeAttribute("title"),
        this.u = !0);
        Xf(this)
    }
    ;
    ...
    Ag.prototype.f = function(a) {
        ...
        a && 1 == a.length && (B(this, "gtouchhmove") || B(this, "gtouchvmove") ? (this.i.a = a[0].clientX,
        this.i.b = a[0].clientY,
        this.b = null) : B(this, "gtouchstart") && (b = new Cg("gtouchstart",this,a),
        A(this, b)),
    ...
    Ag.prototype.F = function(a) {
        ...
        if (c || d) {
            if (!this.b && (this.b = Math.abs(this.i.a - b[0].clientX) > Math.abs(this.i.b - b[0].clientY) ? 1 : 2,
            B(this, "gtouchstart"))) {
                var f = new Cg("gtouchstart",this,b);
                A(this, f)
            }
            c && 1 == this.b && (f = new Cg("gtouchhmove",this,b),
            A(this, f),
            a.stopPropagation(),
            a.a());
            d && 2 == this.b && (f = new Cg("gtouchvmove",this,b),
            A(this, f),
            a.stopPropagation(),
            a.a())
        }
        B(this, "gtouchmove") && (f = new Cg("gtouchmove",this,b),
        A(this, f),
        a.a());
        B(this, "gmultitouchmove") && (f = new Cg("gmultitouchmove",this,b),
        A(this, f),
        a.a())
    }
    ;
    Ag.prototype.B = function(a) {
        a = Bg(a);
        if (1 == a.length && (Cb(this.a, "touchmove", this.F, !1, this),
        Cb(this.a, "touchend", this.B, !1, this),
        B(this, "gtouchend"))) {
            var b = new Cg("gtouchend",this,a);
            A(this, b)
        }
        B(this, "gmultitouchend") && (b = new Cg("gmultitouchend",this,a),
        A(this, b));
    ...
    Dg.prototype.F = function(a) {
        a.stopPropagation();
        a.a();
        this.a || (a = a.touches[0].clientX,
        this.a = !0,
        this.f = a,
        A(this, new Eg("cgtart",a)))
    }
    ;
    Dg.prototype.B = function(a) {
        this.a && (a.stopPropagation(),
        a.a(),
        A(this, new Eg("cgmove",a.touches[0].clientX - this.f)))
    }
    ;
    Dg.prototype.m = function(a) {
        a.stopPropagation();
        a.a();
        this.a && (A(this, new Eg("cgfinish",a.touches[0].clientX - this.f)),
        this.a = !1)
    }
    ;
    function Eg(a, b) {
    ...
    function ye(a) {
        if (a.C)
            ...
            if (isNaN(0))
                throw Error('"(0,0,0,0") is not a valid RGBA color');
            b = xc((0).toString(16));
            b = wc(0, 0, 0) + b
        }
    ...
    e.update = function() {
        ...
        dh(this);
        ch(this);
        this.H && (this.C ? (this.a.setAttribute("href", this.C),
        this.a.setAttribute("target", "parent"),
        E(this.a, fh)) : (this.a.removeAttribute("href"),
    ...
    e.rb = function(a) {
        a = a.B;
        a != this.b.b && (this.a.isVisible() || (this.j.stop(),
        Jh(this)),
        Ig(this.b, a),
        Kh(this))
    }
